      ...
      <div className="container mx-auto px-6 py-12">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-12">
          ...
          <div className="bg-white/90 backdrop-blur-sm p-6 rounded-2xl shadow-xl border border-burgundy-200 hover:shadow-2xl transition-all duration-300">
            ...
            <div className="space-y-3">
              <div className="flex items-center">
                ...
                <span className="text-lg text-burgundy-700 font-cormorant">12 апреля 2026</span>
              </div>
              <div className="flex items-center">
          ...
          <div className="bg-white/90 backdrop-blur-sm p-6 rounded-2xl shadow-xl border border-burgundy-200 hover:shadow-2xl transition-all duration-300">
            ...
            <div className="space-y-2">
              <p className="text-lg text-burgundy-700 font-cormorant font-medium">Ресторан "Колиzей Холл"</p>
              <p className="text-burgundy-600 font-cormorant">Проспект мира, 109А</p>
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="relative group overflow-hidden rounded-xl shadow-lg">
                <img 
                  src="https://i.pinimg.com/736x/5d/8f/3d/5d8f3df50234816aaec6a73e45766e04.jpg" 
              ...
              <div className="relative group overflow-hidden rounded-xl shadow-lg">
                <img 
                  src="https://img.freepik.com/premium-photo/bride-groom-hold-bouquet-flowers_356893-4968.jpg?semt=ais_hybrid&w=740&q=80" 
        ...
        <div className="bg-white/90 backdrop-blur-sm p-8 rounded-2xl shadow-xl border border-burgundy-200 mb-12">
          ...
          <div className="rounded-xl overflow-hidden shadow-lg">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2241.4881797544767!2d37.63409877677259!3d55.819485473108934!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x46b53675e3730235%3A0x417bcd856e73d1c8!2z0KDQtdGB0YLQvtGA0LDQvdC90L4t0LHQsNC90LrQtdGC0L3Ri9C5INC60L7QvNC_0LvQtdC60YEg0JrQvtC70Lh60LXQuSDQpdC-0LvQuw!5e0!3m2!1sru!2sru!4v1771597994783!5m2!1sru!2sru"
              height="400"
              style={{ border: 0 }}
              allowFullScreen
              loading="lazy"
          ...
          <div className="mt-6 text-center">
            <p className="text-burgundy-700 font-cormorant text-lg">
              Ресторан "Колиzей Холл" находится в ВДНХ
            </p>
        ...
        <div className="bg-gradient-to-r from-burgundy-800 to-burgundy-900 p-8 rounded-2xl shadow-xl text-center text-white">
          ...
          <div className="flex justify-center">
            <div className="bg-white/20 backdrop-blur-sm px-6 py-3 rounded-full flex items-center">
              ...
              <span className="text-white font-cormorant font-medium">+7 (991)587-12-18</span>
            </div>
          </div>
        </div>
      </div>
